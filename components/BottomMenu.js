...
export default function BottomMenu({ activePage = 'questions' }) {
  ...
  return (
    <div className="bottom-menu">
      <Link href="/questions" className={`menu-item ${active === 'questions' ? 'active' : ''}`} onClick={() => setActive('questions')}>
      ...
      <Link href="/pair" className={`menu-item ${active === 'pair' ? 'active' : ''}`} onClick={() => setActive('pair')}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link href="/settings" className={`menu-item ${active === 'settings' ? 'active' : ''}`} onClick={() => setActive('settings')}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
